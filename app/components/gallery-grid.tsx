    ...
    <>
      ...
      {open !== null ? (
        <div
          ...
          className="animate-fade fixed inset-0 z-60 flex items-center justify-center bg-ink/96 p-4 backdrop-blur-sm sm:p-10"
        >
          <button
            type="button"
            onClick={() => setOpen(null)}
            className="absolute top-5 right-5 flex h-11 w-11 items-center justify-center rounded-full border border-gold/40 text-gold"
          >
          ...
          <button
            ...
            className="absolute left-3 flex h-12 w-12 items-center justify-center rounded-full border border-gold/40 bg-ink/70 text-gold sm:left-8"
          >
          ...
          <button
            ...
            className="absolute right-3 flex h-12 w-12 items-center justify-center rounded-full border border-gold/40 bg-ink/70 text-gold sm:right-8"
          >
