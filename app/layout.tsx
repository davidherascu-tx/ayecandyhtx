...
export const metadata: Metadata = {
  ...
  description:
    "Aye Candy is a speakeasy cocktail bar hidden behind a candy shop on Bingle Rd in Spring Branch, Houston. Signature cocktails, happy hour, DJs on Friday and Saturday, and private event packages.",
  keywords: [
    "Aye Candy",
    "speakeasy Houston",
